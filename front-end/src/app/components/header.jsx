...
import { useRouter } from "next/navigation";
import useSWR from "swr";
import { setCart } from "../redux/slices/cartSlice"; // Giả sử bạn có một reducer setCart
    ...
    if (token) {
      ...
      fetch("http://localhost:3000/detailuser", {
        ...
        .then((data) => {
          ...
          // Sau khi lấy thông tin người dùng, lấy giỏ hàng từ server
          fetch("http://localhost:3000/cart", {
            ...
            .then((cartData) => {
              ...
              dispatch(setCart(cartData.items)); // Giả sử bạn có một action setCart
            })
            .catch((error) => {
