...
export default function Favourite() {
  ...
  return (
    <div className="container mt-3">
      ...
      <d  iv className="product-favourite">
      {favouriteItems.length > 0 ? (
        ...
        favouriteItems.map((item) => {
          ...
          return (
            <div id="favourite-item" className="rounded position-relative border" key={item._id}>
              <div className="sup-h">
                ...
                <div className="mt-2 fw-medium">
                  <div className="d-flex justify-content-between">
                    ...
                    <span className="icon-favourite" onClick={() => toggleFavourite(item)}>
                      <svg
                  ...
                  <span className="price">
                    {item.discountedPrice > 0 ? (
                      <>
                        <p className="priceSale">${(item.price - (item.price * item.discountedPrice / 100))}</p>
                        <del>${item.price}</del>
                      </>
                    ) : (
            ...
            {item.discountedPrice > 0 && (
              <p className="discount position-absolute">{item.discountedPrice}% OFF</p>
            )}
